...
class DashboardSatistics(RoleAccessList, APIView):
    ...
    def get(self, request):
        ...
        dashboard_statistics['todays_cash']            = todays_cash
        dashboard_statistics['todays_visa']            = todays_visa
        ...
        dashboard_statistics['todays_cash'] -= dashboard_statistics['todays_staff_withdraws_total']
