...
class TestStaffWithdrawUpdate(SetUpDataClass):
    def test_user_with_no_branch_update_staff_withdraw(self):
        ...
        response = self.client.patch(url, self.test_staff_withdraw_1, format = 'json') #admin update Branch
    ...
    def test_user_with_a_branch_update_staff_withdraw(self):
        ...
        self.test_staff_withdraw_1.pop('staff')
        response = self.client.patch(url, self.test_staff_withdraw_1, format = 'json') #manager update StaffWithdraw
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_user_with_no_permission_update_staff_withdraw(self):
        ...
        self.test_staff_withdraw_1.pop('staff')
        response = self.client.patch(url, self.test_staff_withdraw_1, format = 'json') #waiter update Branch
