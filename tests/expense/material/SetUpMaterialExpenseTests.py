...
class SetUpDataClass(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.material_expense_1 = models.MaterialExpense.objects.create(
            material = cls.branch_material_1,
            branch = cls.branch_1,
            total_price = 1000,
            quantity = 10,
            unit_price = 100,
        ...
        cls.material_expense_2 = models.MaterialExpense.objects.create(
            material = cls.branch_material_2,
            branch = cls.branch_1,
            total_price = 1000,
            quantity = 5,
            unit_price = 200,
